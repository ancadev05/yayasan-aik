...
@section('content')
    ...
    <section>
        <div class="container">
            <h5>Kondisi Gedung:</h5>
            <iframe src="{{ asset('assets/img/foto-donasi/renovasi-gedung.mp4?autoplay=1&mute=1') }}" width="100%"
                height="450" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe>
        </div>

        <div class="container mt-5">
            <div class="row row-cols-2 row-cols-md-4 g-4">
                <div class="col">
                    <img src="{{ asset('assets/img/foto-donasi/a-1.jpeg') }}" class="img-fluid gallery-img"
                        alt="Deskripsi Gambar 1" data-bs-toggle="modal" data-bs-target="#imageModal"
                        onclick="showImage(this)">
                </div>
                <div class="col">
                    <img src="{{ asset('assets/img/foto-donasi/a-2.jpeg') }}" class="img-fluid gallery-img"
                        alt="Deskripsi Gambar 2" data-bs-toggle="modal" data-bs-target="#imageModal"
                        onclick="showImage(this)">
                </div>
                <div class="col">
                    <img src="{{ asset('assets/img/foto-donasi/a-3.jpeg') }}" class="img-fluid gallery-img"
                ...
                <div class="col">
                    <img src="{{ asset('assets/img/foto-donasi/a-5.jpeg') }}" class="img-fluid gallery-img"
                        alt="Deskripsi Gambar 3" data-bs-toggle="modal" data-bs-target="#imageModal"
                        onclick="showImage(this)">
                </div>
                <div class="col">
                    <img src="{{ asset('assets/img/foto-donasi/a-6.jpeg') }}" class="img-fluid gallery-img"
                        alt="Deskripsi Gambar 3" data-bs-toggle="modal" data-bs-target="#imageModal"
                        onclick="showImage(this)">
                </div>
                <div class="col">
                    <img src="{{ asset('assets/img/foto-donasi/a-7.jpeg') }}" class="img-fluid gallery-img"
                        alt="Deskripsi Gambar 3" data-bs-toggle="modal" data-bs-target="#imageModal"
                        onclick="showImage(this)">
                </div>
            </div>
    ...
    <div class="container">
        ...
        <span class="d-block text-center" style="font-size: 30px;font-weight: bold">Rp 2.445.000.000,-</span>
