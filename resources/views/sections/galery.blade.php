<section id="gallery" class="gallery section">
    ...
    <div class="container section-title" data-aos="fade-up">
        <h2>Gallery</h2>
        <div><span>Foto</span> <span class="description-title">Kegiatan</span></div>
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        ...
        <div class="row g-0">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                    <a href="{{ asset('/bootslander/assets/img/gallery/gallery-3.jpg') }}" class="glightbox"
                        data-gallery="images-gallery">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                    <a href="{{ asset('/bootslander/assets/img/gallery/gallery-4.jpg') }}" class="glightbox"
                        data-gallery="images-gallery">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                    <a href="{{ asset('/bootslander/assets/img/gallery/gallery-5.jpg') }}" class="glightbox"
                        data-gallery="images-gallery">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                    <a href="{{ asset('/bootslander/assets/img/gallery/gallery-6.jpg') }}" class="glightbox"
                        data-gallery="images-gallery">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                    <a href="{{ asset('/bootslander/assets/img/gallery/gallery-7.jpg') }}" class="glightbox"
                        data-gallery="images-gallery">
            ...
            <div class="col-lg-3 col-md-4">
                <div class="gallery-item">
                    <a href="{{ asset('/bootslander/assets/img/gallery/gallery-8.jpg') }}" class="glightbox"
                        data-gallery="images-gallery">
