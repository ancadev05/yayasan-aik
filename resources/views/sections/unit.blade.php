<section id="unit" class="section light-background">
    <!-- Section Title -->
    <div class="container section-title" data-aos="fade-up">
        <h2>Unit</h2>
        <div><span></span> <span class="description-title">Amal Usaha</span></div>
            ...
            <div class="col px-4" data-aos="fade-up" data-aos-delay="100" style="height: 100%">
                <div class="card shadow" style="height: 100%">
                    ...
                    <div class="card-body">
                        ...
                        <p class="card-text">Didirikan sejak tau 2011 dan telah resmi terdaftar di Kementian Sosial Republik Indonesia</p>
                    </div>
                </div>
            </div>
            {{-- -- --}}
